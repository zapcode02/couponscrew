...
const schema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/zomato-coupon-code#offerlist',
      name: 'Zomato Coupon Codes & Offers',
      numberOfItems: zomatoOffers.length,
      itemListElement: zomatoOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
