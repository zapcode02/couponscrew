...
const schema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/bookmyshow-coupon-code#offerlist',
      name: 'BookMyShow Coupon Codes & Offers',
      numberOfItems: bookmyshowOffers.length,
      itemListElement: bookmyshowOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
