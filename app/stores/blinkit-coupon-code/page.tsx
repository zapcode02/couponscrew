...
const schema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/blinkit-coupon-code#offerlist',
      name: 'Blinkit Coupon Codes & Offers',
      numberOfItems: blinkitOffers.length,
      itemListElement: blinkitOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
