...
export default function AmazonStore() {
  ...
  const coupons: Coupon[] = [
    {
      ...
      description: 'Shop top electronics & appliances at up to 70% OFF. Save extra with select bank offers.',
      code: 'AMZ70',
    ...
    },
    {
      ...
      description: 'Get flat ₹500 OFF on a minimum order of ₹1,999 for new users on grocery & household products.',
      code: 'AMZNEW',
      verified: 'Verified Today',
      userType: 'New Users Only',
      validTill: '28 Jun 2026'
    },
    {
      id: 'coupon-3',
      badge: 'UP TO 40% OFF',
      ...
      color: '#0D9488',
      type: 'BANK OFFER',
      title: 'Up to 40% OFF on Fashion & Beauty',
      description: 'Shop for fashion, clothing, beauty & personal care products at up to 40% OFF.',
      code: 'AMZFASH',
      verified: 'Verified Today',
      userType: 'All Users',
      validTill: '30 Jun 2026'
    },
    {
      ...
      description: 'Get extra 10% instant discount on ICICI Bank Credit & Debit Cards. Maximum discount up to ₹1,500.',
      code: 'ICICIA10',
      verified: 'Verified Today',
      userType: 'All Users',
      validTill: '30 Jun 2026'
    },
    {
      ...
      description: 'Get FREE delivery on your first order. No minimum order value. Fast shipping on selected locations.',
      code: 'FREEDEL',
      verified: 'Verified Today',
      userType: 'New Users Only',
      validTill: '30 Jun 2026'
  ...
  const faqs = [
    {
      q: 'How do I use an Amazon coupon code?',
      a: 'To use an Amazon coupon code, browse verified codes here on Couponscrew, copy your preferred code by clicking "Copy Code", and paste it into the promo code field during checkout on the Amazon website or app. If it is a deal, simply click "Visit Amazon" to get the discount auto-applied.'
    },
    {
      q: 'Can I use multiple coupon codes on Amazon?',
      a: 'Generally, Amazon only allows one promotional code per order. However, you can often combine a coupon code with automatic sitewide promotions or select bank discount credit card offers.'
    },
    {
      q: 'Why is my Amazon coupon code not working?',
      a: 'A coupon might not work due to specific category exclusions (e.g. some codes apply only to fashion or pantry products), minimum spend requirements, expiry, or user eligibility restrictions (e.g. new users only).'
    },
    {
      q: 'Where can I find the best Amazon offers?',
      a: 'We keep this Amazon store page updated 24/7 with the best discounts, verified coupon codes, bank offers, and upcoming event dates (such as Prime Day or Great Summer Sale).'
    },
    {
      q: 'Does Amazon offer free delivery?',
      a: 'Yes, Amazon offers FREE delivery on your first order for new customers. Existing Prime members receive free standard or express shipping on all eligible Prime products without minimum cart limits.'
    },
    {
      q: 'How often are Amazon coupons updated?',
      ...
      <section className="w-full bg-[#FFFFFF] pt-6 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2  text-xs md:text-sm text-[#4A4A6A] select-none mb-6">
            ...
            <ChevronRight size={14} className="text-gray-400" />
            <span className="text-[#5B4FBE] font-semibold">Amazon</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 bg-white rounded-3xl p-6 md:p-8 border border-[#E8E8F0] shadow-sm flex flex-col justify-between">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex flex-col items-center gap-3">
                  <div className="w-28 h-28 bg-white border border-[#E8E8F0] rounded-2xl flex items-center justify-center p-4 shadow-sm shrink-0">
                    <img
                      src="https://res.cloudinary.com/dgy1atvb8/image/upload/v1781457499/amazon-logo_o727tq.png"
                      alt="Amazon Logo"
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <p className="text-sm md:text-base leading-relaxed text-[#4A4A6A]">
                    Shop online for electronics, fashion, home, grocery & more at India's largest online store. Get the best deals with Amazon coupon codes & offers.
                  </p>
            ...
            {/* Premium 3D Promo Banner (Right 5 Columns) — desktop only */}
            <div className="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-[#4E36E0] to-[#7B2CBF] rounded-3xl p-8 text-white relative overflow-hidden flex-col justify-between shadow-sm min-h-[300px]">
              {/* Abstract Glowing Backdrop Shapes */}
              <div className="absolute top-[-30px] right-[-30px] w-48 h-48 bg-white/5 rounded-full blur-2xl pointer-events-none" />
              <div className="absolute bottom-[-50px] left-[-30px] w-64 h-64 bg-pink-500/10 rounded-full blur-3xl pointer-events-none" />

              {/* Tag Accent */}
              <span className="self-start text-[10px] font-black tracking-widest bg-white/20 border border-white/30 px-3 py-1 rounded-full uppercase">
                Summer Special
              </span>
              ...
              <div className="my-auto space-y-3 relative z-10">
                <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-none text-white">
                  UP TO <br />
                  <span className="text-[#FFD700]">80% OFF</span>
                </h2>
                <p className="text-sm font-bold text-white/90">
                  On Top Brands & Electronics Products
                </p>
                <p className="text-xs text-white/70 font-medium">
                  Verified deals only. Grab the biggest coupons before they expire.
                </p>
              </div>

              {/* Floating elements styling */}
              <div className="flex items-center justify-between border-t border-white/20 pt-5 mt-4 relative z-10">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white hover:bg-gray-100 text-[#5B4FBE] font-black text-xs px-5 py-2.5 rounded-lg shadow-sm transition-transform active:scale-95 flex items-center gap-1.5"
                >
                  <span>Shop Top Brands</span>
                  <ArrowRight size={12} />
                </a>
              </div>
            </div>
        ...
        <div className="flex flex-row items-stretch">
          ...
          >
            ...
            <h2 className="text-xl sm:text-3xl lg:text-[38px] font-black leading-none tracking-tight my-1.5 text-center">
              {coupon.badge ? coupon.badge.replace("UP TO ", "").replace("FLAT ", "") : "70%"}
            </h2>
            <span className="text-[9px] sm:text-[11px] uppercase tracking-[1px] font-medium opacity-90 text-center">
              OFF
            </span>
          ...
          <div className="flex-1 flex flex-col lg:flex-row items-stretch">
              ...
              {isExpanded && (
                <ul className="mt-4 space-y-2 text-xs sm:text-sm text-slate-600 border-t border-dashed border-slate-200 pt-4">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Flat 10% OFF on sitewide bookings.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0066FF] mt-1.5 block h-1.5 w-1.5 shrink-0 rounded-full bg-[#0066FF]" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#0066FF] mt-1.5 block h-1.5 w-1.5 shrink-0 rounded-full bg-[#0066FF]" />
                    <span>Covers selected categories and live shows.</span>
                  </li>
                </ul>
              )}
            </div>
            ...
            <div className="text-center pt-2">
              <button className="bg-white border border-[#E8E8F0] hover:border-[#5B4FBE] hover:text-[#5B4FBE] text-[#1A1A2E] font-black text-xs px-6 py-3.5 rounded-xl transition-all shadow-xs inline-flex items-center gap-1.5 cursor-pointer">
                <span>View More Coupons (115+)</span>
                <ChevronDown size={14} />
              </button>
            </div>
          ...
          <aside className="w-full lg:w-80 flex-shrink-0 self-start space-y-6 order-2">
            ...
            <div className="bg-white border border-[#E8E8F0] rounded-3xl p-5 shadow-xs">
              <h3 className="font-extrabold text-[#1A1A2E] text-base mb-4 tracking-tight flex items-center gap-2 border-b border-[#E8E8F0] pb-3 select-none">
                ...
                <span>Amazon - Store Information</span>
              </h3>
              <p className="text-[#1A1A2E] text-sm">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsam facere excepturi ducimus at possimus blanditiis quam libero aut laboriosam accusamus eius, similique dolore harum exercitationem assumenda commodi quidem aperiam nostrum?
            ...
            <div className="bg-gradient-to-br from-[#5B4FBE] to-[#7C3AED] rounded-3xl p-6 text-white relative overflow-hidden flex flex-col justify-between shadow-xs min-h-[220px]">
              ...
              <div className="space-y-2 relative z-10 text-left">
                <h3 className="font-extrabold text-lg tracking-tight">Amazon Great Summer Sale</h3>
                ...
                <p className="text-white/80 text-xs mt-2 leading-relaxed">
                  Up to 70% OFF on Mobiles, Electronics, Fashion & more
                </p>
              </div>
            ...
            <div className="bg-white border border-[#E8E8F0] rounded-3xl p-5 shadow-xs">
              ...
              <div className="space-y-3.5 text-xs">
                ...
                <div className="flex justify-between items-center font-semibold">
                  <span className="text-[#1A1A2E]">Mobiles & Accessories</span>
                  <span className="text-[#FF5722] font-bold">Up to 60% OFF</span>
                </div>
                <div className="flex justify-between items-center font-semibold">
                  <span className="text-[#1A1A2E]">Fashion & Beauty</span>
                  <span className="text-[#FF5722] font-bold">Up to 60% OFF</span>
                </div>
                <div className="flex justify-between items-center font-semibold">
                ...
                <div className="flex justify-between items-center font-semibold">
                  <span className="text-[#1A1A2E]">Books & Education</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-20">
            ...
            <div className="prose max-w-none">
              ...
              <div className={cn("text-gray-500 font-bold leading-relaxed space-y-6 relative", !isReadMore && "max-h-[500px] overflow-hidden")}>
                <h3 className="text-xl font-black text-[#5B4FBE] mb-4">Gear Up for Less with OutfitR Coupon Codes</h3>
                <p>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-black text-[#5B4FBE] mb-4">Why Choose OutfitR?</h3>
                ...
                <div className="space-y-8 bg-white p-10 rounded-[40px] border border-[#f0f0f0] shadow-sm my-12">
                  <h3 className="text-xl font-black text-[#5B4FBE] mb-8">How to Use an OutfitR Coupon Code</h3>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-black text-[#5B4FBE] mb-4">Smart Ways to Save More at OutfitR</h3>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-black text-[#5B4FBE] mb-4">Why Quality Outdoor Gear Matters</h3>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-black text-[#5B4FBE] mb-4">Why Use Couponsbit for OutfitR Deals?</h3>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-black text-[#5B4FBE] mb-4">Get Ready for Your Next Adventure</h3>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 group cursor-pointer">
                      ...
                      <a href="https://outfitr.com" target="_blank" rel="noopener noreferrer" aria-label={`Get OutfitR deal: ${deal.heading}`} className="bg-[#e8f6f8] text-[#0451c4] px-3.5 py-2 rounded-xl text-[12px] font-black uppercase tracking-widest hover:bg-[#5B4FBE] hover:text-white transition-all active:scale-90">Get Deal</a>
                    </div>
                  ))}
                </div>
              </div>
