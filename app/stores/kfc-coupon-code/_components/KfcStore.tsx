          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="mt-8 pt-6 border-t border-[#F0E0E0] flex flex-wrap gap-4">
                ...
                <button
                  ...
                  className={`font-bold text-sm px-6 py-3.5 rounded-xl transition-all border flex items-center gap-2 ${isFavorite
                    ...
                    : 'bg-white border-[#E0D0D0] text-[#1A1A1A] hover:bg-gray-50'
                    }`}
                >
            ...
            >
              <div className="text-white space-y-3 relative z-10">
                ...
                <h3 className="text-2xl font-black leading-tight">Seasonal Meal Offers</h3>
                <p className="text-white/80 text-sm">Combo meals, buckets & snacks at great prices</p>
              </div>
            </a>
          </div>
        </div>
