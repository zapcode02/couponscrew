...
const schema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/kfc-coupon-code#offerlist',
      name: 'KFC Coupon Codes & Offers',
      numberOfItems: kfcOffers.length,
      itemListElement: kfcOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
