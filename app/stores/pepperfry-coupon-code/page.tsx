...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/pepperfry-coupon-code#offerlist',
      name: 'Pepperfry Coupon Codes & Offers',
      numberOfItems: pepperfryOffers.length,
      itemListElement: pepperfryOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
