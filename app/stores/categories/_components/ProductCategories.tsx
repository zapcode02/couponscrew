...
const PRODUCT_CATEGORIES = [
  ...
  },
  {
    slug: 'electronics',
    name: 'Electronics',
    description: 'Smartphones, laptops, gadgets and accessories from trusted stores — verified deals.',
    icon: Smartphone,
    productCount: 1,
    color: '#5B4FBE',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788085983/electronics_xz4hcp.webp',
  },
  {
    slug: 'food-and-grocery',
    name: 'Food & Grocery',
    description: 'Food delivery, instant grocery and daily essentials from trusted stores — verified deals.',
    icon: Utensils,
    productCount: 1,
    color: '#FC8019',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788085983/food-and-grocery_zqodvj.webp',
  },
  {
    slug: 'travel',
    name: 'Travel',
    description: 'Flights, buses, cabs and travel bookings from trusted platforms — verified deals.',
    icon: Plane,
    productCount: 1,
    color: '#0084FF',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788085983/travel_pgz9yv.webp',
  },
  {
    slug: 'education',
    name: 'Education',
    description: 'Online courses, test series and exam prep from trusted platforms — verified deals.',
    icon: BookOpen,
    productCount: 1,
    color: '#6366F1',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788085983/education_emgxnm.webp',
  },
  {
    slug: 'entertainment',
    name: 'Entertainment',
    description: 'Streaming subscriptions, movie tickets and event bookings — verified deals.',
    icon: Tv,
    productCount: 1,
    color: '#EC4899',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788085983/entertainment_ncu768.webp',
  },
  {
    slug: 'finance',
    name: 'Finance',
    description: 'Personal loans, credit cards, insurance and investment platforms — verified deals.',
    icon: Landmark,
    productCount: 1,
    color: '#0F766E',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091237/Finance_msks78.webp',
  },
  {
    slug: 'web-hosting',
    name: 'Web Hosting',
    description: 'Shared hosting, VPS, domains and cloud hosting plans — verified deals.',
    icon: Server,
    productCount: 1,
    color: '#2563EB',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091237/web-hosting_ydzalx.webp',
  },
  {
    slug: 'health',
    name: 'Health',
    description: 'Pharmacy, health supplements, fitness and diagnostic services — verified deals.',
    icon: HeartPulseIcon,
    productCount: 1,
    color: '#DC2626',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091237/furniture_hvjg57.webp',
  },
  {
    slug: 'sports',
    name: 'Sports',
    description: 'Sportswear, fitness equipment and sports accessories — verified deals.',
    icon: Trophy,
    productCount: 1,
    color: '#16A34A',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091237/Sports_y2gtef.webp',
  },
  {
    slug: 'software',
    name: 'Software',
    description: 'Productivity software, antivirus, design tools and business software — verified deals.',
    icon: Code2,
    productCount: 1,
    color: '#4338CA',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091236/software_cgwsul.webp',
  },
  {
    slug: 'gaming',
    name: 'Gaming',
    description: 'Console games, PC downloads and gaming accessories — verified deals.',
    icon: Gamepad2,
    productCount: 1,
    color: '#7C3AED',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091237/gaming_bcbf8k.webp',
  },
  {
    slug: 'jewellery',
    name: 'Jewellery',
    description: 'Gold, diamond and fashion jewellery, watches and gifting sets — verified deals.',
    icon: Gem,
    productCount: 1,
    color: '#B45309',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091236/jewellery_ehbdae.webp',
  },
  {
    slug: 'eyewear',
    name: 'Eyewear',
    description: 'Eyeglasses, sunglasses and contact lenses — verified deals.',
    icon: Glasses,
    productCount: 1,
    color: '#0891B2',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091236/eyewear_ididva.webp',
  },
  {
    slug: 'furniture',
    name: 'Furniture',
    description: 'Living room, bedroom and office furniture and home décor — verified deals.',
    icon: Armchair,
    productCount: 1,
    color: '#92400E',
    bg: '#1a56db',
    image: 'https://res.cloudinary.com/dqjlffxja/image/upload/v1788091330/furniture_bvajgk.webp',
  },
];
