...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'Organization',
      '@id': 'https://www.couponscrew.com/stores/lenskart-coupon-code#brand',
      name: 'Lenskart',
      url: 'https://www.lenskart.com',
      sameAs: ['https://en.wikipedia.org/wiki/Lenskart'],
    },
  ...
  "mainEntity": [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/lenskart-coupon-code#offerlist',
      name: 'Lenskart Coupon Codes & Offers',
      numberOfItems: lenskartOffers.length,
      itemListElement: lenskartOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
