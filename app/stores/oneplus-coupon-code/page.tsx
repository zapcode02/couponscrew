...
const schema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/oneplus-coupon-code#offerlist',
      name: 'OnePlus Coupon Codes & Offers',
      numberOfItems: oneplusOffers.length,
      itemListElement: oneplusOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
