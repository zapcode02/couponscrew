      ...
      <section className="w-full bg-[#FFFFFF] pt-6 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2  text-xs md:text-sm text-[#4A4A6A] select-none mb-6">
            <Link href="/" className="hover:text-[#00205B] transition-colors font-medium">Home</Link>
            <ChevronRight size={14} className="text-gray-400" />
            <Link href="/stores" className="hover:text-[#00205B] transition-colors font-medium">Stores</Link>
            <ChevronRight size={14} className="text-gray-400" />
            <span className="text-[#00205B] font-semibold">IndiGo Coupon Code</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 bg-white rounded-3xl p-6 md:p-8 border border-[#E8E8F0] shadow-sm flex flex-col justify-between">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1 space-y-4">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className="bg-[#EAF0FA] text-[#00205B] text-xs font-bold px-3 py-1 rounded-full border border-[#D6E0F0]">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-xs font-semibold text-[#4A4A6A]">
                    ...
                    <span className="flex items-center gap-1.5 text-[#00205B] bg-[#EAF0FA] px-2.5 py-1 rounded-full border border-[#D6E0F0]">
              ...
              <div className="mt-8 pt-6 border-t border-[#E8E8F0] flex flex-wrap gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer nofollow sponsored"
                  className="bg-[#F5A623] hover:bg-[#D68F0F] text-white font-extrabold text-sm px-7 py-3.5 rounded-xl transition-all flex items-center gap-2 shadow-md hover:shadow-lg active:scale-95 cursor-pointer"
                >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer nofollow sponsored"
              className="hidden lg:flex lg:col-span-5 relative overflow-hidden rounded-3xl shadow-sm min-h-[300px] bg-gradient-to-br from-[#00205B] to-[#0B3D91] items-center justify-center text-center p-8"
            >
              <div className="text-white space-y-3 relative z-10">
                <span className="inline-block bg-[#F5A623] text-[#00205B] text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-wider">
                  Limited Time
                </span>
      ...
      <section className="hidden lg:block bg-white border-b border-[#E8E8F0] py-6 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 select-none">
          <div className="flex items-center gap-3.5 border-r border-[#E8E8F0]/70 last:border-0 pr-4">
            <div className="w-11 h-11 bg-[#EAF0FA] text-[#00205B] rounded-2xl flex items-center justify-center shrink-0">
              <Tag size={18} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3.5 md:border-r border-[#E8E8F0]/70 last:border-0 pr-4">
            <div className="w-11 h-11 bg-[#FDF3E3] text-[#F5A623] rounded-2xl flex items-center justify-center shrink-0">
              <TrendingUp size={18} />
            </div>
            <div>
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-row items-stretch">
          ...
          {/* LEFT DISCOUNT SECTION - Deep Theme Primary (#00205B) */}
          <div
            className="w-24 sm:w-32 lg:w-40 bg-[#00205B] flex flex-col items-center justify-center py-6 px-2 text-white relative shrink-0"
          >
          ...
          <div className="flex-1 flex flex-col lg:flex-row items-stretch">
            ...
            <div className="flex-1 p-4 sm:p-5 lg:p-6 flex flex-col justify-center">
              <div className="flex flex-wrap items-center gap-2 mb-2 sm:mb-3">
                {/* Soft Tint Badge using Accent (#F5A623) */}
                <span className="bg-[#F5A623]/10 text-[#F5A623] text-[9px] sm:text-[10px] font-bold px-2.5 py-1 rounded-md uppercase tracking-wide">
              ...
              <button
                ...
                className="mt-3 flex items-center gap-1 text-xs sm:text-sm font-bold text-[#00205B] hover:opacity-80 w-fit transition-opacity"
              >
                View Details
              ...
              {isExpanded && (
                <ul className="mt-4 space-y-2 text-xs sm:text-sm text-slate-600 border-t border-dashed border-slate-200 pt-4">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 block h-1.5 w-1.5 shrink-0 rounded-full bg-[#00205B]" />
            ...
            <div className="lg:w-64 w-full border-t lg:border-t-0 lg:border-l border-dashed border-slate-300 p-4 sm:p-5 lg:p-6 flex flex-col justify-center items-center lg:items-stretch bg-transparent">
              ...
              {/* Coupon Code Box */}
              {coupon.code && (
                <div className="w-full bg-white border border-dashed border-[#F5A623]/40 rounded-xl flex items-center justify-between px-4 py-2.5 mb-3">
    ...
    <span className="font-bold text-[#2C2C40]">Tip:</span> If a Hostinger promo code shows as invalid, check that the code applies to your selected plan type (some codes are shared-hosting-only or VPS-only) and that you are on a qualifying billing cycle (most codes require annual or 2-year billing). Refresh this CouponsCrew page for the next active code.
              ...
              <div className="mt-5 select-none">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer nofollow sponsored"
                  className="w-full border border-[#D1D1E9] hover:border-[#00205B] hover:text-[#00205B] text-[#1A1A2E] py-3.5 rounded-xl text-xs font-black transition-all flex items-center justify-center gap-1 bg-white cursor-pointer"
                >
                  <span>Visit IndiGo</span>
                  <ArrowRight size={12} />
                </a>
            ...
            <div className="bg-gradient-to-br from-[#00205B] to-[#0B3D91] rounded-3xl p-6 text-white relative overflow-hidden flex flex-col justify-between shadow-xs min-h-[220px]">
              ...
              <div className="space-y-2 relative z-10 text-left">
                ...
                <span className="inline-block bg-[#F5A623] text-[#00205B] text-[9px] font-black px-2 py-0.5 rounded-md uppercase tracking-wider">
                  Live Now!
                </span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
                className="mt-6 w-full bg-white hover:bg-gray-100 text-[#00205B] py-3 rounded-xl text-xs font-black text-center transition-all cursor-pointer relative z-10 block"
              >
                Book Now
              </a>
            </div>
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="flex items-center gap-4 group cursor-pointer">
                ...
                <a href={AFFILIATE_URL} target="_blank" rel="noopener noreferrer nofollow sponsored" aria-label={`Get IndiGo deal: ${deal.heading}`} className="bg-[#f0eeff] text-[#0451c4] px-3.5 py-2 rounded-xl text-[12px] font-black uppercase tracking-widest hover:bg-[#5B4FBE] hover:text-white transition-all active:scale-90">Get Deal</a>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl border border-[#E8E8F0] shadow-2xl p-6 md:p-8 max-w-md w-full text-center relative space-y-5 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-400 leading-relaxed font-semibold">
                Use the code <span className="font-extrabold text-[#00205B]">{activeModalCoupon.code}</span> at IndiGo checkout for instant discounts.
              </p>
            </div>
            ...
            <div className="pt-2 flex flex-col gap-2">
              <a
                ...
                className="w-full bg-[#F5A623] hover:bg-[#D68F0F] text-white py-3.5 rounded-xl text-xs font-black transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-md"
              >
