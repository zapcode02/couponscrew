...
const schema = {
  ...
  "mainEntity": [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/hostinger-coupon-code#offerlist',
      name: 'Hostinger Coupon Codes & Offers',
      numberOfItems: hostingerOffers.length,
      itemListElement: hostingerOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
