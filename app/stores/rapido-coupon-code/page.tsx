...
const schema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'ItemList',
      '@id': 'https://www.couponscrew.com/stores/rapido-coupon-code#offerlist',
      name: 'Rapido Coupon Codes & Offers',
      numberOfItems: rapidoOffers.length,
      itemListElement: rapidoOffers.map((offer, index) => ({
        '@type': 'ListItem',
        position: index + 1,
        item: offer,
      })),
