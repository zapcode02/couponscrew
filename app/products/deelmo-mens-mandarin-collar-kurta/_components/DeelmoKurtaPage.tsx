...
export default function DeelmoKurtaPage() {
  ...
  const relatedProducts = [
    {
      name: "DEELMO Men's Printed Short Kurta",
      price: 549,
      originalPrice: 1299,
      discount: 58,
      image: 'https://images.unsplash.com/photo-1622445275576-721325763afe?w=300&q=80',
      rating: 4.0
    },
    {
      name: "DEELMO Men's Linen Blend Kurta",
      price: 649,
      originalPrice: 1499,
      discount: 57,
    ...
    {
      name: "DEELMO Men's Half Sleeve Kurta",
      price: 499,
      originalPrice: 1199,
      discount: 58,
    ...
    {
      name: "DEELMO Men's Nehru Jacket Kurta Set",
      price: 899,
      originalPrice: 1999,
      discount: 55,
      image: 'https://images.unsplash.com/photo-1593030103066-0093718efeb9?w=300&q=80',
      rating: 4.3
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 w-full flex-1">
        ...
        <div className="space-y-6 mb-10">
          <div className="flex justify-between items-end border-b border-gray-200 pb-3">
            <h3 className="text-xl font-black text-[#1A1A2E]">More Men's Kurtas You'll Love</h3>
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-4 group cursor-pointer">
                        ...
                        <a href="https://amzn.to/3R7tzTR" target="_blank" rel="noopener noreferrer nofollow sponsored" aria-label={`Get DEELMO deal: ${deal.heading}`} className="bg-[#e8f6f8] text-[#0451c4] px-3.5 py-2 rounded-xl text-[12px] font-black uppercase tracking-widest hover:bg-[#5B4FBE] hover:text-white transition-all active:scale-90">Get Deal</a>
                      </div>
                    ))}
                  </div>
                </div>
