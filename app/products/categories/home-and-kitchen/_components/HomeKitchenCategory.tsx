...
import {
  ...
  ArrowRight, Home, Package, RefreshCw, Lock, ExternalLink
} from 'lucide-react';
...
const PRODUCTS = [
  {
    ...
    originalPrice: 1999,
    discountPercent: 90,
    affiliateUrl: 'https://amzn.to/4bdFyGa',
    slug: '/products/desidiya-moon-crystal-night-light',
    isPopular: true,
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-10 items-center text-left">
          ...
          <div className="md:col-span-5 flex items-center justify-center relative w-full">
            <div className="relative w-full h-[280px] rounded-3xl overflow-hidden shadow-2xl">
              <img src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&q=80" alt="Home & Kitchen" className="w-full h-full object-cover rounded-3xl hover:scale-105 transition-transform duration-700" referrerPolicy="no-referrer" />
              ...
              <div className="absolute bottom-4 right-4 bg-white rounded-2xl p-5 shadow-2xl min-w-[180px] border border-[#E8E8F0]/40 z-10 text-left">
                ...
                <div className="text-xl font-black text-[#1A1A2E] tracking-tight mt-0.5">HOME DÉCOR</div>
                <div className="text-xs text-[#4A4A6A] mt-1.5 font-semibold">Up to</div>
                <div className="text-3xl font-black text-[#5B4FBE] leading-none mt-0.5 tracking-tight">90% OFF</div>
                <a href="https://amzn.to/4bdFyGa" target="_blank" rel="noopener noreferrer nofollow sponsored" className="bg-[#FF5722] hover:bg-orange-600 text-white px-5 py-2.5 rounded-full text-xs font-bold mt-4 block w-full text-center transition-all shadow-md">Shop Now</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row gap-8 items-start">
          <div className="flex-1 w-full text-left">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-3 pb-4 border-b border-[#E8E8F0]">
              <div>
                <h2 className="font-bold text-xl text-[#1A1A2E] leading-none">Home & Kitchen Products ({PRODUCTS.length})</h2>
          ...
          <aside className="w-full lg:w-72 flex-shrink-0 space-y-5 lg:sticky lg:top-24 text-left">
            ...
            <div className="bg-gradient-to-br from-[#FF6B9D] to-[#FF3F6C] rounded-2xl p-6 relative overflow-hidden shadow-xl text-white">
              ...
              <div className="relative z-10">
                <h3 className="font-bold text-lg">Love Home Décor?</h3>
                <p className="text-white/80 text-xs mt-2 leading-relaxed font-semibold">Get the best home deals straight to your inbox.</p>
                ...
                {newsAlert && <div className="mt-3 text-[11px] bg-white/15 border border-white/20 rounded-xl p-2.5 font-bold">✓ You're subscribed to home décor deals!</div>}
              </div>
            </div>
          </aside>
        </div>
