...
import {
  ...
  ArrowRight, ShoppingBag, Package, RefreshCw, Lock, ExternalLink
} from 'lucide-react';
      ...
      <section className="relative w-full bg-white border-b border-[#E8E8F0] min-h-[320px] py-10 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-10 items-center text-left">
          <div className="md:col-span-7 flex flex-col items-start">
            ...
            <p className="mt-3 max-w-md text-[#4A4A6A] text-base leading-relaxed">Trending fashion picks for men and women — verified Amazon prices, real savings every time.</p>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row gap-8 items-start">
          <div className="flex-1 w-full text-left">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-3 pb-4 border-b border-[#E8E8F0]">
              <div>
                <h2 className="font-bold text-xl text-[#1A1A2E] leading-none">Fashion Products ({PRODUCTS.length})</h2>
          ...
          <aside className="w-full lg:w-72 flex-shrink-0 space-y-5 lg:sticky lg:top-24 text-left">
              ...
              <div className="space-y-3.5">
                {PRODUCTS.map((p, i) => (
                  <div key={p.id} className="flex items-center gap-3 group">
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-black flex-shrink-0 ${i === 0 ? 'bg-[#FFD700] text-[#1A1A2E]' : 'bg-gray-200 text-[#1A1A2E]'}`}>{i + 1}</div>
            ...
            <div className="bg-gradient-to-br from-[#FF6B9D] to-[#FF3F6C] rounded-2xl p-6 relative overflow-hidden shadow-xl text-white">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/80 text-xs mt-2 leading-relaxed font-semibold">Get the best fashion deals straight to your inbox.</p>
                ...
                {newsAlert && <div className="mt-3 text-[11px] bg-white/15 border border-white/20 rounded-xl p-2.5 font-bold">✓ You're subscribed to fashion deals!</div>}
              </div>
            </div>
          </aside>
        </div>
