...
// ============================================================================
// HARDCODED OFFERS DATA — PEPPERFRY
// ============================================================================
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-shrink-0 text-center w-20 flex sm:flex-col items-center justify-between sm:justify-start gap-3 sm:gap-0 mx-auto sm:mx-0 w-full sm:w-20">
                        <div className="w-16 h-16 rounded-2xl flex items-center justify-center transition-transform duration-300 group-hover:scale-105 shadow-xs border border-[#E8E8F0] bg-white overflow-hidden">
                          <img
